  ...
  useEffect(() => {
    ...
    const [decstatus,setdecstatus]=useState('');
     ...
     const get_fees_record=async(student_code:any,school_id:any)=>{
        try{
            const res=await axios.get(`http://localhost:8000/schoolstudentfees/${student_code}/${school_id}/January/${currentYear}`);
        ...
        try{
            const res=await axios.get(`http://localhost:8000/schoolstudentfees/${student_code}/${school_id}/February/${currentYear}`);
        ...
        try{
            const res=await axios.get(`http://localhost:8000/schoolstudentfees/${student_code}/${school_id}/March/${currentYear}`);
        ...
        try{
            const res=await axios.get(`http://localhost:8000/schoolstudentfees/${student_code}/${school_id}/April/${currentYear}`);
        ...
        try{
            const res=await axios.get(`http://localhost:8000/schoolstudentfees/${student_code}/${school_id}/May/${currentYear}`);
        ...
        try{
            const res=await axios.get(`http://localhost:8000/schoolstudentfees/${student_code}/${school_id}/June/${currentYear}`);
        ...
        try{
            const res=await axios.get(`http://localhost:8000/schoolstudentfees/${student_code}/${school_id}/July/${currentYear}`);
        ...
        try{
            const res=await axios.get(`http://localhost:8000/schoolstudentfees/${student_code}/${school_id}/August/${currentYear}`);
        ...
        try{
            const res=await axios.get(`http://localhost:8000/schoolstudentfees/${student_code}/${school_id}/September/${currentYear}`);
        ...
        try{
            const res=await axios.get(`http://localhost:8000/schoolstudentfees/${student_code}/${school_id}/October/${currentYear}`);
        ...
        try{
            const res=await axios.get(`http://localhost:8000/schoolstudentfees/${student_code}/${school_id}/November/${currentYear}`);
              if(res.data.length===0){
        ...
        try{
            const res=await axios.get(`http://localhost:8000/schoolstudentfees/${student_code}/${school_id}/December/${currentYear}`);
