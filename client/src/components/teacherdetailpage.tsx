   ...
   if(!auth){
    ...
    interface RouteParams {
      ...
      const getstudent = async (id: any,admin_id:any) => {
        setload(true);
        try {
          const res = await axios.get(`http://localhost:8000/apiteacher/${admin_id}/${id}`);
          setdata(res.data);
          setload(false);
        } catch (err) {
          setload(true);
              ...
              <div ref={coverttopdf} style={{width:'100%',margin:'auto',padding:'20px'}}>
                <div style={{padding:'20px'}} className="mr-auto flex justify-center align-middle">
                  <img
                    ...
                    src={`http://localhost:8000/${el.teacher_img}`}
                    alt="nature image"
                  />
                </div>
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-5">
                  ...
                  <div style={{ borderBottom: '1px solid silver' }}>
                   ...
                   <div style={{ borderBottom: '1px solid silver' }}>
                    ...
                    <a href={`http://localhost:8000/${el.teacherdocs}`}>Click here</a>
                  </div>
